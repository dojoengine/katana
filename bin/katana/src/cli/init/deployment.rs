...
pub async fn deploy_settlement_contract(
    ...
    let result = async {
        ...
        const INITIAL_STATE_ROOT: Felt = Felt::from_hex_unchecked("0x529f8903315a861413a2ecfaa7dd168fe8d82b53d08eddccb7a0672bff7807");
        ...
        const INITIAL_BLOCK_NUMBER: Felt = Felt::ZERO;
