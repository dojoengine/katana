...
```
[`cairo/game/src/lib.cairo:114`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/cairo/game/src/lib.cairo#L114)
...
```
[`cairo/game/src/lib.cairo:80`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/cairo/game/src/lib.cairo#L80)
...
send_message_to_l1_syscall(config.registry.into(), array![player, score.into()].span())
    .unwrap_syscall();
```
[`cairo/game/src/lib.cairo:131`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/cairo/game/src/lib.cairo#L131)
...
```
[`cairo/score/src/lib.cairo:99`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/cairo/score/src/lib.cairo#L99)
...
```
[`cairo/game/src/lib.cairo:71`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/cairo/game/src/lib.cairo#L71)
