...
```
[`app/src/chain.ts:79`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L79)

Two parsing details every client needs:

- **Columns come back as hex strings** (`"0x…41"`). Collapse to numbers:
  `const num = (v) => Number(BigInt(v));` [`app/src/chain.ts:44`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L44)
- **Each event row has `internal_event_id`** = `block:txHash:world:idx`. Split it
  ...
  gating): [`app/src/chain.ts:87`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L87)
...
```
[`app/src/chain.ts:115`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L115)
...
```
[`app/src/chain.ts:216`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L216)
...
- **Block heights** (appchain tip) and **piltover `get_state`** (settled height) —
  the "settled N / tip M" gauge. [`app/src/chain.ts:277`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L277)
- **The L1 purchase log** (piltover `MessageSent`) via `getEvents`, so a purchase
  ...
  either world. [`app/src/chain.ts:185`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L185)
...
- **L1→L2 (buy):** `piltover.send_message_to_appchain(game_system, mint_selector, payload)` — [`app/src/chain.ts:141`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L141)
- **L2 (play):** `gameSystem.play_game()` — [`app/src/chain.ts:249`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L249)
- **L2→L1 (bank):** `scoreSystem.claim_score(game_system, player, score)` — [`app/src/chain.ts:288`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L288)
...
- **A write returns before the read updates.** `playGame()` sends the tx, waits
  ...
  [`app/src/chain.ts:249`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/chain.ts#L249)
...
```
[`app/src/App.tsx:79`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/App.tsx#L79)
...
```
[`app/src/App.tsx:127`](https://github.com/dojoengine/katana/blob/279073a3d4fd6e99ada6ec40bd5c3e1f9bd28bbc/examples/cross-chain-game/app/src/App.tsx#L127)
