...
pub struct TxFeeInfo {
    ...
    pub l1_gas_consumed: u128,
    /// The L1 gas price at the time of the transaction execution.
    pub l1_gas_price: u128,
    /// The total amount of L2 gas consumed by the transaction.
    pub l2_gas_consumed: u128,
    /// The L2 gas price at the time of the transaction execution.
    pub l2_gas_price: u128,
    /// The total amount of L1 data gas consumed by the transaction.
    pub l1_data_gas_consumed: u128,
    /// The L1 data gas price at the time of the transaction execution.
