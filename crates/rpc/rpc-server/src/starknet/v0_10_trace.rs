//! v0.10 Trace API implementation.
//!
//! Trace API types are identical between v0.9 and v0.10 — thin delegation.
...
use katana_rpc_api::starknet::v0_10::StarknetTraceApiServer;
