...
fn invoke_confirmed_receipt() {
    let json = fixtures::test_data::<Value>("v0.9/receipts/v3/invoke_confirmed.json");
...
#[test]
fn invoke_preconfirmed_receipt() {
    let json = fixtures::test_data::<Value>("v0.9/receipts/v3/invoke_preconfirmed.json");
    let full_receipt: TxReceiptWithBlockInfo = serde_json::from_value(json.clone()).unwrap();
    let TxReceiptWithBlockInfo { transaction_hash, receipt, block } = full_receipt.clone();

    assert_matches!(&block, ReceiptBlockInfo::PreConfirmed {  block_number } => {
        assert_eq!(*block_number, 1832699);
    });
...
fn declare_confirmed_receipt() {
    let json = fixtures::test_data::<Value>("v0.9/receipts/v3/declare_confirmed.json");
    let full_receipt: TxReceiptWithBlockInfo = serde_json::from_value(json.clone()).unwrap();
    let TxReceiptWithBlockInfo { transaction_hash, receipt, block } = full_receipt.clone();
...
#[test]
fn declare_preconfirmed_receipt() {
    let json = fixtures::test_data::<Value>("v0.9/receipts/v3/declare_preconfirmed.json");
    let full_receipt: TxReceiptWithBlockInfo = serde_json::from_value(json.clone()).unwrap();
    let TxReceiptWithBlockInfo { transaction_hash, receipt, block } = full_receipt.clone();
...
fn deploy_account_confirmed_receipt() {
    let json = fixtures::test_data::<Value>("v0.9/receipts/v3/deploy_account_confirmed.json");
    let full_receipt: TxReceiptWithBlockInfo = serde_json::from_value(json.clone()).unwrap();
    let TxReceiptWithBlockInfo { transaction_hash, receipt, block } = full_receipt.clone();
...
#[test]
fn deploy_account_preconfirmed_receipt() {
    let json = fixtures::test_data::<Value>("v0.9/receipts/v3/deploy_account_preconfirmed.json");
    let full_receipt: TxReceiptWithBlockInfo = serde_json::from_value(json.clone()).unwrap();
    let TxReceiptWithBlockInfo { transaction_hash, receipt, block } = full_receipt.clone();
...
fn l1_handler_confirmed_receipt() {
    let json = fixtures::test_data::<Value>("v0.9/receipts/v3/l1_handler_confirmed.json");
    let full_receipt: TxReceiptWithBlockInfo = serde_json::from_value(json.clone()).unwrap();
    let TxReceiptWithBlockInfo { transaction_hash, receipt, block } = full_receipt.clone();
...
#[test]
fn l1_handler_preconfirmed_receipt() {
    let json = fixtures::test_data::<Value>("v0.9/receipts/v3/l1_handler_preconfirmed.json");
    let full_receipt: TxReceiptWithBlockInfo = serde_json::from_value(json.clone()).unwrap();
    let TxReceiptWithBlockInfo { transaction_hash, receipt, block } = full_receipt.clone();
