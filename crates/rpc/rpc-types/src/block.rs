...
// #[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
// pub struct BlockWithTxsAndReceipts {
//     pub status: FinalityStatus,
//     pub block_hash: BlockHash,
//     pub parent_hash: BlockHash,
//     pub block_number: BlockNumber,
...
//     pub starknet_version: String,
//     pub transactions: Vec<RpcTxWithHash>,
//     pub receipts: Vec<RpcTxWithReceipt>,
// }

// impl BlockWithTxsAndReceipts {
//     pub fn new(
//         block_hash: BlockHash,
//         block: Block,
//         finality_status: FinalityStatus,
...
// #[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
// pub struct PreConfirmedBlockWithTxsAndReceipts {
//     pub block_number: BlockNumber,
//     pub timestamp: u64,
//     pub sequencer_address: ContractAddress,
//     pub l1_gas_price: ResourcePrice,
...
// impl PreConfirmedBlockWithTxsAndReceipts {
//     pub fn new(
//         header: PartialHeader,
