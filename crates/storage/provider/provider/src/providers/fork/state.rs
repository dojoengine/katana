...
impl<Tx1: DbTx, Tx2: DbTxMut> HistoricalStateProvider<Tx1, Tx2> {
    fn new(
        local_provider: db::state::HistoricalStateProvider<Tx1>,
        fork_provider: ForkedDb<Tx2>,
    ) -> Self {
        Self { fork_provider, local_provider }
    }
}
...
impl<Tx1: DbTx, Tx2: DbTxMut> StateWriter for ForkedProvider<Tx1, Tx2> {
...
impl<Tx1: DbTx, Tx2: DbTxMut> ContractClassWriter for ForkedProvider<Tx1, Tx2> {
