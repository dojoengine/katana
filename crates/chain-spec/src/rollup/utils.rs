...
//         ChainSpec { id, genesis, settlement, fee_contracts, versioned_constants_overrides: None }
//     }
...
//         let res =
// genesis_state.class_hash_of_contract(DEFAULT_APPCHAIN_FEE_TOKEN_ADDRESS).unwrap();
